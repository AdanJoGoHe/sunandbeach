...
public class WoodenMace extends SwordItem{

  public static final ToolMaterial WOODEN_MACE_MATERIAL = new ToolMaterial() {
  ...
  public WoodenMace(ToolMaterial toolMaterial, int attackDamage, float attackSpeed,
                    Settings settings) {
