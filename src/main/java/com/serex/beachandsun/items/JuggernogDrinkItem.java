...
public class JuggernogDrinkItem extends Item {
  public JuggernogDrinkItem(Settings settings) {
    super(settings);
  }
  ...
  public ItemStack finishUsing(ItemStack stack, World world, LivingEntity user) {
    ...
    if (playerEntity == null || !playerEntity.getAbilities().creativeMode) {
      playerEntity.playSound(ModSounds.LC_SHOP_SONG,100,1);
      ...
      if (stack.isEmpty()) {
        ...
        return new ItemStack(ItemInit.EMPTY_TROPICAL_CAN);
      }
      if (playerEntity != null) {
